...
//= Styles
import cls from './scrollables.module.scss';
...
function ScrollLine({ data }: IProps) {
  return (
    <div className={cls.scrollables}>
      <div className={cls.scroll_line_left}>
        {/* Github Icon */}
      ...
      <div className={cls.scroll_line_right}>
        <p><a href={`mailto:${data.emailAddress}`}>{data.emailAddress}</a></p>
        <span></span>
      </div>
    </div>
  )
